package com.example.vaibhav.ocrkotlinversion.ui.camera.ui.camera
...
/**
 * Created by Vaibhav on 5/12/17.
 */
class CameraSource {
    @SuppressLint("InlinedApi")
    private var CAMERA_FACING_BACK: Int = Camera.CameraInfo.CAMERA_FACING_BACK
    @SuppressLint("InlinedApi")
    private var CAMERA_FACING_FRONT: Int = Camera.CameraInfo.CAMERA_FACING_FRONT

    private var TAG: String = "OpenCameraSource"
    private var DUMMY_TEXTURE_NAME: Int = 100
    private var ASPECT_RATIO_TOLERANCE: Float = 0.01f
    ...
    private var mCameraLock = Object();
    private var mCamera: Camera? = null
    private var mFacing: Int = CAMERA_FACING_BACK;
    private var mRotation: Int? = null;
    private var mPreviewSize: Size? = null;
    private var mRequestedFps: Float = 30.0f;
    private var mRequestedPreviewWidth: Int = 1024;
    private var mRequestedPreviewHeight: Int = 768;
    private var mFocusMode: String? = null;
    private var mFlashMode: String? = null;
    private var mDummySurfaceView: SurfaceView? = null;
    private var mDummySurfaceTexture: SurfaceView? = null;
    ...
    (context: Context?, mDetector: Detector<*>?) {
    ...
    fun start(): CameraSource {
        synchronized(mCameraLock) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                mDummySurfaceTexture = SurfaceView(DUMMY_TEXTURE_NAME)
    ...
    private class SizePair(previewSize: android.hardware.Camera.Size,
        ...
        private val mPreview: com.google.android.gms.common.images.Size
        private var mPicture: com.google.android.gms.common.images.Size? = null

        init {
            mPreview = com.google.android.gms.common.images.Size(previewSize.width, previewSize.height)
            if (pictureSize != null) {
                mPicture = com.google.android.gms.common.images.Size(pictureSize.width, pictureSize.height)
            }
        }

        fun previewSize(): com.google.android.gms.common.images.Size {
            return mPreview
        }

        fun pictureSize(): com.google.android.gms.common.images.Size? {
            return mPicture
        }
    }
     ...
     */
    private fun createPreviewBuffer(previewSize: com.google.android.gms.common.images.Size): ByteArray {
